...
export function attachMediaTypeToCid(mediaUri: string, mimeType?: string | null): string {
...
export function getClueMediaKind(mediaCid?: string | null): ClueMediaKind | null {
...
export function getClueMediaSource(mediaCid?: string | null, gatewayIndex = 0): string | null {
  if (!mediaCid) return null;
