...
export const SEED_HUNTS: StoredHunt[] = [
  ...
  },
  {
    ...
    description: "Explore the local nature reserve and identify wildlife.",
    cluesCount: 6,
    category: "nature",
    tags: ["outdoor", "walking", "wildlife", "family-friendly"],
    status: "Active",
    rewardType: "XLM",
    rewardPool: 100,
    poolBalance: 100,
    ...
    endTime: NOW_SECONDS + 14 * 86400,
    difficulty: "Easy",
  },
  {
    id: 7,
    title: "Foodie Trail Downtown",
    description: "Taste your way through the best eateries in the city.",
    cluesCount: 8,
    category: "food",
    tags: ["food", "downtown", "walking", "team"],
    status: "Active",
    rewardType: "Both",
    rewardPool: 300,
    poolBalance: 300,
