  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Stellar Network</h3>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 p-6 max-w-md mx-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  {pendingNetwork === 'mainnet' ? (
                    ...
                    <>
                      You're about to switch to{' '}
                      <span className="font-semibold text-slate-900 dark:text-white">Testnet</span>.
                      You'll be using test XLM for development purposes. The page will reload to
                      apply changes.
                    </>
                  )}
                </p>
            ...
            <div className="flex gap-3">
              <Button onClick={cancelNetworkChange} variant="outline" className="flex-1">
                Cancel
              </Button>
              <Button
