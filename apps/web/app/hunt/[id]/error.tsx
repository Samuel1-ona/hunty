...
import { dispatchAlert } from "@/lib/monitoring/alertChannels"
...
export default function Error({
  ...
  useEffect(() => {
    logger.error("[HuntRouteError] Unhandled error:", error)
    Sentry.captureException(error, {
      tags: { boundary: "HuntRouteError", digest: error.digest },
    })
    dispatchAlert({
      id: crypto.randomUUID(),
      level: "critical",
      title: "Hunt Route Error",
      message: error.message,
      source: "hunt-route-error-boundary",
