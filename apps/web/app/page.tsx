      ...
      <div className="p-5">
              ...
              className={`shrink-0 inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-semibold border ${
                hunt.difficulty === 'Easy'
                  ...
                  : hunt.difficulty === 'Medium'
                    ? 'bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-500/20 dark:text-yellow-300 dark:border-yellow-500/30'
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {hunt.averageDifficulty != null && (
            <span
              className="inline-flex items-center gap-1 rounded-full bg-slate-100 dark:bg-slate-700 px-2 py-0.5 text-[10px] font-semibold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600"
              title="Average Player Difficulty Rating"
            >
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-600">
            Featured creator placements for the next 24 hours.
          </p>
        </div>
          ...
          >
            <div className="mb-3 flex items-center justify-between gap-2">
              ...
              <span className="text-xs text-slate-500">
                Ends{' '}
                {hunt.promotedUntil ? new Date(hunt.promotedUntil * 1000).toLocaleString() : 'soon'}
              </span>
            </div>
  ...
  return (
    <section className="mt-12">
      ...
      <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-slate-50 shadow-sm">
        ...
        >
          <path
            d="M80 120C150 60 220 30 310 50C355 60 400 90 450 100C490 108 530 80 580 88C655 100 720 170 780 150C860 120 930 150 950 200V438C880 384 820 370 760 398C700 425 620 448 550 420C480 392 405 360 332 370C245 382 140 448 80 438V120Z"
            fill="rgba(79,70,229,0.08)"
            stroke="rgba(79,70,229,0.12)"
            strokeWidth="2"
          />
          <path
            d="M150 250C210 200 270 180 340 210C410 240 455 228 510 185C560 145 610 130 700 170C760 195 815 195 865 175"
            fill="none"
          ...
          />
          <path
            d="M125 292C174 260 220 270 250 312C275 346 314 355 342 332C378 303 417 285 460 298C515 315 545 372 600 390C675 415 722 340 800 322C870 306 905 328 945 344"
            fill="none"
                  ...
                  <div className="p-5 flex flex-col justify-between h-full">
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {hunt.averageDifficulty != null && (
                          <span
                            className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-700 border border-slate-200"
                            title="Average Player Difficulty Rating"
                          >
                            Difficulty: {hunt.averageDifficulty}/4
                          </span>
...
export default function GameArcade() {
  ...
  useEffect(() => {
    ...
    if (rewardFilter !== 'all') params.set('reward', rewardFilter);
    ...
    >
      ...
      <div className="max-w-[1600px] px-14 pt-10 pb-12 bg-white dark:bg-slate-900 mx-auto rounded-4xl relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <Button
            asChild
            className="bg-gradient-to-b from-[#3737A4] to-[#0C0C4F] hover:opacity-90 text-white px-6 py-3 rounded-lg text-xl font-black gap-2"
          >
            <Link href="/feed">
