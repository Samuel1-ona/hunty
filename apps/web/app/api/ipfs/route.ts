...
import { MAX_IPFS_UPLOAD_BYTES } from "@/lib/ipfs"
import { getIP, rateLimit } from "@/lib/rate-limit"

const PINATA_JWT = process.env.PINATA_JWT
// Serverless platforms (e.g. Vercel) reject bodies above ~4.5 MB with an
// opaque platform error. Reject earlier with a clear validation message.
const MAX_FILE_SIZE = MAX_IPFS_UPLOAD_BYTES
