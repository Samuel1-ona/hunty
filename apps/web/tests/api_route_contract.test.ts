...
const ROUTE_MANIFEST: RouteEntry[] = [
  // ── admin ────────────────────────────────────────────────────────────
  {
    file: 'admin/anti-cheat/route.ts',
    path: '/api/admin/anti-cheat',
    methods: ['GET', 'POST'],
    auth: 'admin',
  },
  {
    file: 'admin/featured/route.ts',
    path: '/api/admin/featured',
    methods: ['GET', 'POST'],
    auth: 'admin',
  },
  {
    file: 'admin/featured/rotate/route.ts',
    path: '/api/admin/featured/rotate',
    methods: ['POST'],
    auth: 'admin',
    noBody: true,
  },
  {
    file: 'admin/moderation/route.ts',
  ...
  // ── analytics ────────────────────────────────────────────────────────
  {
    file: 'analytics/hint-usage/route.ts',
    path: '/api/analytics/hint-usage',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'analytics/[huntId]/route.ts',
    path: '/api/analytics/[huntId]',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'analytics/hunt-view/route.ts',
    path: '/api/analytics/hunt-view',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'analytics/performance/route.ts',
  ...
  // ── hunts ────────────────────────────────────────────────────────────
  {
    file: 'hunts/schedule/route.ts',
    path: '/api/hunts/schedule',
    methods: ['POST'],
    auth: 'public',
    noBody: true,
  },
  ...
  // ── moderation ───────────────────────────────────────────────────────
  {
    file: 'moderation/submit/route.ts',
    path: '/api/moderation/submit',
    methods: ['POST'],
    auth: 'public',
  },
  {
    file: 'moderation/sync/route.ts',
    path: '/api/moderation/sync',
    methods: ['GET', 'POST'],
    auth: 'admin',
  },
  ...
  // ── notifications ────────────────────────────────────────────────────
  {
    file: 'notifications/complete/route.tsx',
    path: '/api/notifications/complete',
    methods: ['POST'],
    auth: 'public',
  },
  ...
  {
    file: 'og/leaderboard/route.ts',
    path: '/api/og/leaderboard',
    methods: ['GET'],
    auth: 'public',
  },
  ...
  // ── v1 / feature-flags ───────────────────────────────────────────────
  {
    file: 'v1/feature-flags/route.ts',
  ...
  { file: 'v1/hunts/[id]/route.ts', path: '/api/v1/hunts/[id]', methods: ['GET'], auth: 'public' },
  {
    file: 'v1/hunts/[id]/archive/route.ts',
    path: '/api/v1/hunts/[id]/archive',
    methods: ['POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/collaborators/route.ts',
    path: '/api/v1/hunts/[id]/collaborators',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/complete/route.ts',
    path: '/api/v1/hunts/[id]/complete',
    methods: ['POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/delete/route.ts',
    path: '/api/v1/hunts/[id]/delete',
    methods: ['POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/leaderboard/route.ts',
    path: '/api/v1/hunts/[id]/leaderboard',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/leaderboard/export/route.ts',
    path: '/api/v1/hunts/[id]/leaderboard/export',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/leaderboard/public/route.ts',
    path: '/api/v1/hunts/[id]/leaderboard/public',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/players/route.ts',
    path: '/api/v1/hunts/[id]/players',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/progress/route.ts',
    path: '/api/v1/hunts/[id]/progress',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/ratings/route.ts',
    path: '/api/v1/hunts/[id]/ratings',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/reviews/route.ts',
    path: '/api/v1/hunts/[id]/reviews',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'v1/hunts/[id]/reviews/[reviewId]/moderate/route.ts',
    path: '/api/v1/hunts/[id]/reviews/[reviewId]/moderate',
    methods: ['POST'],
    auth: 'public',
  },
  ...
  // ── v1 / seasons ─────────────────────────────────────────────────────
  {
    file: 'v1/seasons/route.ts',
    path: '/api/v1/seasons',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
  {
    file: 'v1/seasons/[id]/route.ts',
    path: '/api/v1/seasons/[id]',
    methods: ['GET', 'POST', 'PATCH'],
    auth: 'public',
  },
  {
    file: 'v1/seasons/archived/route.ts',
    path: '/api/v1/seasons/archived',
    methods: ['GET'],
    auth: 'public',
  },
  {
    file: 'v1/seasons/badges/route.ts',
    path: '/api/v1/seasons/badges',
    methods: ['GET', 'POST'],
    auth: 'public',
  },
...
describe('API route manifest', () => {
  ...
  describe('OG hunt route ownership', () => {
    it('keeps exactly one handler for /api/og/hunt/[id]', () => {
      ...
      expect(ROUTE_MANIFEST.filter((entry) => entry.path === '/api/og/hunt/[id]')).toEqual([
  ...
  describe('POST body rejection', () => {
    const postRoutes = ROUTE_MANIFEST.filter((r) => r.methods.includes('POST') && !r.noBody);
